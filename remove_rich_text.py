#script to remove tags from transcription/subtile file
...
parser = ArgumentParser(description='Remove tags from transcription/subtitle file \n\r'+
						"How to Run?\n" +
...
for line in lines:
	...
	line = re.sub(r' *$', "", line, flags = re.MULTILINE)
	line = re.sub(r' +', " ", line, flags = re.MULTILINE)
	line = re.sub(r'\*Music', "Music", line, flags = re.MULTILINE)
	print(line)
	#print(line2)