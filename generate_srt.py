...
def generateSRT(i, t):
	...
	langfp = open(langfilename,"r",encoding='utf8')
	tlfp = open(timelinefile,"r",encoding='utf8')
	outfp = open("outfile.srt","w")
	...
	for l in langcontent:
		#l = l.strip()
		#print("1",l)
		#l = re.sub(r'(\[SUB____\d+\])([\.])$',r'\2\1',l, flags=re.MULTILINE)
		#l = re.sub(r'(\[SUB(.+)?\])([\.])$',r'\3\1',l, flags=re.MULTILINE)
		l = re.sub(r'\.\n','. ',l)
